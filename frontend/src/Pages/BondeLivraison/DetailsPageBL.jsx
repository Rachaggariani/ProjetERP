...
import { fetchClientBLById } from "../../ReduxToolkit/Features/ClientBLSlice";
import MapComponent from "../../Components/MapComponent/MapComponent";
import axios from "axios";

function DetailsPageBL() {
          ...
          <div className="card-content">
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <div>
                ...
                <div>
                  <p>Adresse: {clientsBLData.adresse_livraison}</p>
                </div>
                <div>
                  <p>Magasin: {clientsBLData.magasin}</p>
                  <div>
                  <p>Mobile: {clientsBLData.mobile}</p>
                </div>
                </div>
              </div>
              <div>
                ...
                <thead>
                  <tr>
                    ...
                    <th
                      ...
                      className="text-right"
                    >
                      {"Remise %".charAt(0).toUpperCase() +
                        "Remise %".slice(1).toLowerCase()}
                    </th>
                    <th
                      style={{ color: "black", textTransform: "capitalize" }}
                      className="text-right"

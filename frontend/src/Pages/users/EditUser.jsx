    ...
    <div className="main-content">
      <div className="layout-px-spacing">
        <div style={{ marginTop: "50px", marginBottom: "40px" }}>
          <h1 style={{ color: "#0063DC" }}>Update User</h1>
        </div>
                                ...
                                <div className="form-group">
                                  ...
                                  >
                                    ...
                                    {societes.map((societe) => (
                                      <option value={societe.code}>
                                        {societe.nom}
                                      </option>
                                    ))}
                                  </select>
                                  {formErrors.societe_code && (
                                    <span className="text-danger">
                                      {formErrors.societe_code}
                                    </span>
                                  )}
                                      ...
                                      <div className="row">
                                        ...
                                        <div className="col-md-6">
                                          <div className="form-group">
                                            ...
                                            >
                                              <option>Choose...</option>
                                              <option value="prevendeur">
                                                Prevendeur
                                              </option>
                                              <option value="cashvan">
                                                Cashvan
                                              </option>
                                              <option value="livreur">
                                                Livreur
                                              </option>
                                              <option value="cashvan_livreur">
                                                cashvan_livreur
                                              </option>
